...
var currentEstimate = {
    ...
    hoursThisWeek:0,
    raw: '',
    initialize: function() { this.hours= 0; this.tasks= 0; this.weeks = 0; this.lastEstimate = 0; this.hoursThisWeek = 0},
    addHours: function(newHours) { raw = newHours; this.lastEstimate = parseFloat(newHours) || 0; this.hours += this.lastEstimate; this.tasks += 1; this.hoursThisWeek += this.lastEstimate},
    nextWeek: function () { this.tasks = 0; this.weeks += 1; this.hoursThisWeek = 0}
}
